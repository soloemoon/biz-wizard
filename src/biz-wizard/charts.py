...
class bizcharts:
    """
    A class used to generate common business charts on a set of data
    ...

    Attributes
    ----------
    data : dataframe
        a dataframe containing the data to be graphed

    Methods
    -------
    bullet_graph(sound=None)
